            ...
            while True:
                ...
                if data == 'send':
                    ...
                    if hash_generated_by_server == hash_value:
                        print("THEY MATCHED NEED TO send  delete message")
                        connection.sendall("del")
            ...
            if choice in ['send', 's']:
                ...
                while True:
                    ...
                    if server_file_status == 'nope':
                        ...
                        print(personal_data)
                        calculated_hashed_value = hasher(personal_data)
                        print(calculated_hashed_value)

                        if(hash_value == calculated_hashed_value):
                            print(decrypt_personal_data(personal_data))
                            sock.sendall('del')
                            open(filename, "wb").write(decrypt_personal_data(personal_data))
                        break
                    break
    finally:
